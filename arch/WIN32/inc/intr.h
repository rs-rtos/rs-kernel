...
#define SIMUF_IF    0x00000001
#define SIMUF_IE    0x00000002
...
#define IRQ_SAVEAREA        int8u _intsave

#define irq_lock() \
do { \
    _intsave = simuFL.b.IE; \
    simuFL.b.IE = 0; \
} while (0)

#define irq_unlock() \
do { \
    simuFL.b.IE = _intsave; \
} while (0)
...
#define HOOK_KERNEL_ENTRY() simulator_initialize()
#define HOOK_KERNEL_IDLE()  simulator_idle()
...
void simulator_postirq(int irq);
void simulator_idle(void);

extern simuFL_t simuFL;
